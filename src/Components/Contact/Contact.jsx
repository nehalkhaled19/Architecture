              ...
              <form>
                <div className='row justify-content-between'>
                  <div className="col-lg-6 mb-4">
                    <input className="form-control py-3  " type="text" placeholder='Name' value="Name" aria-label="readOnly input example" readOnly />

                  </div>
                  <div className="col-lg-6 mb-4">
                    <input className="form-control py-3" type="email" placeholder='Email' value="Email" aria-label="readOnly input example" readOnly />
                  </div>
                </div>
                <div className='mb-4'>
                  <input className="form-control py-3" type="text" placeholder='Subject' value="Subject" aria-label="readOnly input example" readOnly />
                </div>
                <div className='mb-4' >
